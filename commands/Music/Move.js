module.exports = { 
    ...
    run: async (client, message, args) => {
        ...
        if (tracks == 0 && position == 0) return message.reply(`Cannot move a song that is already playing`);
        ...
        return message.reply({ content: `**Moved • [${song.title}](<${song.uri}>)** to ${position}` });
    }
}