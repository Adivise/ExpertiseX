    ...
    const handleEarrape = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post(`http://${config.ip}:${port}/earrape`, { guildId });
...
`;
    ...
    return (
        <div id="earrape" className="content">
            <div className="markdown-container">
                <h2>Earrape (Headphone Warning)</h2>
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleEarrape} disabled={isCooldown}>
