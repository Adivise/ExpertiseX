    ...
    const handleNormal = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post(`http://${config.ip}:${port}/normal`, { guildId });
...
`;
    ...
    return (
        <div id="normal" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleNormal} disabled={isCooldown}>
