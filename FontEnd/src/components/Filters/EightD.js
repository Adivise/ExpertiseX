    ...
    const handleEightD = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post(`http://${config.ip}:${port}/eightd`, { guildId });
...
`;
    ...
    return (
        <div id="eightd" className="content">
            <div className="markdown-container">
                <h2>8D (Headphone Recommended)</h2>
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleEightD} disabled={isCooldown}>
