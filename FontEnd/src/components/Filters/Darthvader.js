    ...
    const handleDathvader = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post(`http://${config.ip}:3000/darthvader`, { guildId });
...
`;
    ...
    return (
        <div id="dathvader" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleDathvader} disabled={isCooldown}>
