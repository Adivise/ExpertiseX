    ...
    const handleVibrate = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post('http://localhost:3000/vibrate', { guildId });
...
`;
    ...
    return (
        <div id="vibrate" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleVibrate} disabled={isCooldown}>
