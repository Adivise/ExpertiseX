    ...
    const handleSuperBass = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post('http://localhost:3000/superbass', { guildId });
...
`;
    ...
    return (
        <div id="superbass" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleSuperBass} disabled={isCooldown}>
