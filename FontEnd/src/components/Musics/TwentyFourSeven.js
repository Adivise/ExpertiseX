    ...
    const handleTwentyFourSeven = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post(`http://${config.ip}:${port}/twentyfourseven`, { guildId, twentyfourseven: twentyfourseven.value });
    ...
    return (
        <div id="twentyfourseven" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                />
                <Select
                    options={TwentyFourSevenOption}
                    value={twentyfourseven}
                    onChange={setTwentyFourSeven}
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleTwentyFourSeven} disabled={isCooldown}>
