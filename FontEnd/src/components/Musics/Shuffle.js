    ...
    const handleShuffle = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post(`http://${config.ip}:3000/shuffle`, { guildId });
...
`;
    ...
    return (
        <div id="shuffle" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleShuffle} disabled={isCooldown}>
