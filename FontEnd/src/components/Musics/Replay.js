    ...
    const handleReplay = async (event) => {
        ...
        if (!isCooldown) {
            ...
            try {
                ...
                const { data } = await axios.post('http://localhost:3000/replay', { guildId });
...
`;
    ...
    return (
        <div id="replay" className="content">
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleReplay} disabled={isCooldown}>
