...
module.exports = async (client) => {
    const dirPath = path.join(__dirname, "../listeners/track");
    ...
    try {
        ...
        console.error(`❌ Error loading track events:`, e);
    }
    console.log(`Loaded track events: ${count} total`); // ✅ Debugging track event loading
};