...
const Daycore = ({ userId }) => {
    ...
    return (
        <div id="daycore" className="content">
            <div className="markdown-container">
                <h2>Daycore</h2>
                <div className="description">
                    <p>Enter the details below to set the daycore filter.</p>
                    <ul>
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleDaycore} disabled={isCooldown}>
