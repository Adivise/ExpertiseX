...
const DoubleTime = ({ userId }) => {
    ...
    return (
        <div id="doubletime" className="content">
            <div className="markdown-container">
                <h2>Double-Time</h2>
                <div className="description">
                    <p>Enter the details below to set the double-time filter.</p>
                    <ul>
            ...
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleDoubleTime} disabled={isCooldown}>
