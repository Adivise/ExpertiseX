...
const Forward = ({ userId }) => {
    ...
    return (
        <div id="forward" className="content">
            <div className="markdown-container">
                <h2>Forward</h2>
                <div className="description">
                    <p>Enter the details below to forward the currently playing song.</p>
                    <ul>
                        <li>Guild ID (ex: 1234567890)</li>
                        <li>Seconds to forward (default: 10)</li>
                    </ul>
                </div>
            </div>
            <form className="styled-form" onKeyDown={handleKeyPress}>
                ...
                <div style={{ marginTop: '20px' }}>
                    <button type="button" onClick={handleForward} disabled={isCooldown}>
