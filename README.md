...
### Windows Users
- Click [here](https://github.com/Adivise/ExpertiseX/releases/latest/download/expertisex-3.3.0.exe) to download the recommended Windows installer
- Alternative downloads from the [latest release](https://github.com/Adivise/ExpertiseX/releases/latest):
  - **Portable (.exe)**
    - `expertisex-3.3.0-portable.exe` (no installation required, settings reset on close)
  - **MSI Installer (.msi)**
    - `expertisex-3.3.0.msi` (alternative for enterprise environments)
...
- Click [here](https://github.com/Adivise/ExpertiseX/releases/latest/download/expertisex-3.3.0.dmg) to download the recommended macOS installer
- Alternative downloads from the [latest release](https://github.com/Adivise/ExpertiseX/releases/latest):
  - **PKG Installer (.pkg)**
    - `expertisex-3.3.0.pkg` (for Apple Silicon Macs)
...
- Click [here](https://github.com/Adivise/ExpertiseX/releases/latest/download/expertisex-3.3.0.AppImage) to download the recommended Linux AppImage
- Alternative downloads from the [latest release](https://github.com/Adivise/ExpertiseX/releases/latest):
  - **Debian Package (.deb)**
    - `expertisex_3.3.0.deb`
  - **RPM Package (.rpm)**
    - `expertisex-3.3.0.rpm`
  > *You may need to make the AppImage executable: `chmod +x ./expertisex-3.3.0.AppImage` and then run it.*
